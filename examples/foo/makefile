...
TARGET_BASE1=test_foo
#TARGET_BASE2=test2
TARGET1 = $(TARGET_BASE1)$(TARGET_EXTENSION)
#TARGET2 = $(TARGET_BASE2)$(TARGET_EXTENSION)
SRC_FILES1=$(UNITY_ROOT)/src/unity.c src/foo.c  test/TestFoo.c  test/test_runners/TestFoo_Runner.c
...
test/test_runners/TestFoo_Runner.c: test/TestFoo.c
	ruby $(UNITY_ROOT)/auto/generate_test_runner.rb test/TestFoo.c  test/test_runners/TestFoo_Runner.c
